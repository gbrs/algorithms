...
Sqrt-декомпозиция. Задачи нахождения суммы/макс/мин на отрезке \[l...r] массива A.  
...
и несколько центральных, входящих полностью. Крайние считаем тривиально. O(sqrt(n)).  
