...
Для шагов каждый раз вызываем рекурсивно алгоритм. Можно стек явный.  
...
Кратко:  
Нахождения кратчайшего пути в ориентированном ацикличном графе.  
Топологическая сортировка. dfs. Складываем в список вершины при последнем посещении узла (в конце ф-ции дфс). 
Переворачиваем список в конце. Все пути в нем идут слева-направо.  
...
Отмечаем достижимые компоненты №1. Теперь строим ксс для следующей в топсорте вершины, которую мы еще не посетили.  
...
Запускаем бфс из A. Пусть расстояние 4. Запускаем бфс из B. 
На кратчайших путях лежат все вершины, для которых сумма расстояний в этих массивах равна 4. 
Ребро лежит на кратчайшем пути, если сумма расстояний от одной вершины до A и от другой до B равна 3.  
...
Если получившаяся соседняя клетка не выходит за границы, не посещена и является сушей, то добавляем в очередь.  
