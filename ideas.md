...
k должен быть меньше размера алфавита, p - большое число (чтобы не было коллизий). 
Вроде, есть мнение, что они должны быть взаимно простыми. Чтобы деление по модулю можно было делать?  
...
Если хеши совпали, то надо проверить вручную?  
...
Поэтому смещаться надо на величину, учитывающую такие повторы. Вот это правило как звучит, я не понял.  
Создают префикс-функцию - массив, в котором на i-ой позиции максимально возможная длина совпадающих префиксов и 
суффиксов на отрезке s'[0:i]. Кстати, префикс и суффикс могут пересекаться. 
